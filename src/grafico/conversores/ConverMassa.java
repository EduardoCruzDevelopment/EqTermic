...
public class ConverMassa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        combEntrada.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "g", "Kg", "L", "mL", "cm³" }));

        combResult.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        combResult.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Kg", "g", "L", "mL", "cm³" }));
        ...
        if(txtEntrada.getText().isEmpty()){
            ...
            if(de.equals(para)){
                ...
                try{
                    ...
                    Double r = c.massa(de, para, Double.parseDouble(txtEntrada.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConverMassa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConverMassa().setVisible(true);
            }
        });
    }
