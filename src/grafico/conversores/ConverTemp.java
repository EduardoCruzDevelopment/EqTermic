...
public class ConverTemp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        combEntrada.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "°C", "°F", "K" }));

        combResult.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        combResult.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "K", "°F", "°C" }));
        ...
        if(txtEntrada.getText().isEmpty()){
            ...
            if(de.equals(para)){
                ...
                try{
                    ...
                    Double r = c.temperatura(de, para, Double.parseDouble(txtEntrada.getText()));
